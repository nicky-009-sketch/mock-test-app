...
const AppStack = () => {
  ...
  return (
    <Drawer.Navigator
      drawerContent={(props) => <Menu {...props} profile={profile} />}
    >
      <Drawer.Screen
        name='BottomTab'
...
const BottomTabStack = () => {
  ...
  return (
    <Tab.Navigator initialRouteName="Home" screenOptions={{ tabBarStyle: { height: 56, padding: 6 } }}>
      <Tab.Screen
        name='Home'
        component={Home}
        options={{
      ...
      <Tab.Screen
        ...
        options={{
          ...
          tabBarIcon: ({ color, size }) => (
            <Entypo name="line-graph" color={color} size={22} />
          )
        }}
      />
      <Tab.Screen

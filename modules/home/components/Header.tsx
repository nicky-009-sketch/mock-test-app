...
import SelectExam from '../../exam/components/SelectExam';

const Header: React.FC<{ navigation: any, bottomSheetModalRef: any, handlePresentModalPress: any }> = ({ navigation, bottomSheetModalRef: any, handlePresentModalPress }) => {
